...
CREATE TABLE IF NOT EXISTS public.travel_countdowns (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    user_id UUID REFERENCES public.users(id) ON DELETE CASCADE NOT NULL,
    travel_profile_id UUID REFERENCES public.travel_profiles(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_expenses_travel_profile_id ON public.expenses(travel_profile_id);
CREATE INDEX IF NOT EXISTS idx_budgets_user_id ON public.budgets(user_id);
CREATE INDEX IF NOT EXISTS idx_budgets_travel_profile_id ON public.budgets(travel_profile_id);
CREATE INDEX IF NOT EXISTS idx_travel_countdowns_user_id ON public.travel_countdowns(user_id);
CREATE INDEX IF NOT EXISTS idx_travel_countdowns_travel_profile_id ON public.travel_countdowns(travel_profile_id);
